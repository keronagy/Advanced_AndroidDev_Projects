...
public class DBAdapter {
	...
	// Change the field names (column names) of your table
	...
	public static final int COL_STUDENTSCORE = 2;
	public static final int COL_TIME = 3;


	public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_SCORE,KEY_TIME };
	...
	public Cursor getAllRows() {
		...
		Cursor c = 	db.query(true, DATABASE_TABLE, ALL_KEYS,
							where, null, null, null, KEY_SCORE +" DESC " , null);
		if (c != null) {
			c.moveToFirst();
		}
		return c;
	...
	public boolean updateRow(long rowId, int studentScore) {
		String where = KEY_ROWID + "=" + rowId;
